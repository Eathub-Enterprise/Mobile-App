...
export default  function Registrationscreen({navigation}){
    ...
    let states=[
        ...
        {pl:'First name',setter:setfirstname,st:firstname},
        {pl:'Middle name',setter:setmiddlename,st:middlename},
        {pl:'Last name',setter:setlastname,st:lastname},
    ...
    async function Registerapi(){
        ...
        console.log({username,password,gender,firstname,lastname,middlename,phonenumber,email,address})
        const requestOptions={
            method:'Post',
            headers:{'Content-Type': 'application/json'},
            body: JSON.stringify({username,password,gender,firstname,lastname,middlename,phonenumber,email,address})
          }
        try{
            let response=await fetch('https://eathub-web-api.herokuapp.com/api/v1/user/create/client/',requestOptions)
      ...
      <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()} >
        ...
        <ScrollView>
            ...
            <View style={styles.vhead}>
                <Text style={[commonstyles.txt,{fontSize:24}]}>Create</Text>
            ...
            { indicatorVisible ?
                ...
                {states.map((v,i)=>{
                   if((v.pl=="Password" && v.st.length<8) ||(v.pl=="Username" && v.st.length<8)||(v.st.length<5) ){
                    ...
                    return(
                        <View key={v.pl} style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                ...
                <TouchableOpacity style={[styles.continue2,{
                  ...
                  <Text style={[commonstyles.txt,{color:colorSchema.pink,fontSize:16,fontFamily:'reg'}]} 
                  >Go to Login</Text>
                </TouchableOpacity>
